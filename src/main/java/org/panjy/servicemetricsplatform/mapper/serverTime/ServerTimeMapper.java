package org.panjy.servicemetricsplatform.mapper.serverTime;
...
public interface ServerTimeMapper {
     ...
     * @return 留存率数据
     */
    OrderRetentionRate calculateOrderRetentionRateByMonth(@Param("targetDate") LocalDateTime targetDate);
}