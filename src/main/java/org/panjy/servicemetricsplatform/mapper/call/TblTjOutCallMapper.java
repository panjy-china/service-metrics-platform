...
import org.panjy.servicemetricsplatform.entity.call.TblTjOutCall;
...
public interface TblTjOutCallMapper {
     ...
     * @return 通话次数列表
     */
    List<Integer> selectCallCountsByMonth(@Param("yearMonth") String yearMonth);
}