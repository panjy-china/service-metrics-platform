...
public interface OrderStatisticsMapper {
    ...
    @Select({
        ...
        "WHERE o.colEmpID LIKE 'E%'",
        "  AND toDate(o.colOdrTim) = toDate(#{date})"
    })
    ...
    @Select({
        ...
        "FROM aikang.tbl_Order o",
        "WHERE o.colEmpID LIKE 'E%'",
        "  AND toDate(o.colOdrTim) = toDate(#{date}) - INTERVAL 1 DAY"
    })
    ...
    @Select({
        ...
        "FROM aikang.tbl_Order o",
        "WHERE o.colEmpID LIKE 'E%'",
        "  AND o.colOdrTim >= toStartOfWeek(toDate(#{date}), 1)",
        "  AND o.colOdrTim < addWeeks(toStartOfWeek(toDate(#{date}), 1), 1)"
    })
    ...
    @Select({
        ...
        "FROM aikang.tbl_Order o",
        "WHERE o.colEmpID LIKE 'E%'",
        "  AND o.colOdrTim >= toStartOfWeek(toDate(#{date}) - INTERVAL 7 DAY, 1)",
        "  AND o.colOdrTim < addWeeks(toStartOfWeek(toDate(#{date}) - INTERVAL 7 DAY, 1), 1)"
    })
    ...
    @Select({
        ...
        "FROM aikang.tbl_Order o",
        "WHERE o.colEmpID LIKE 'E%'",
        "  AND o.colOdrTim >= toStartOfMonth(toDate(#{date}))",
    ...
    @Select({
        ...
        "FROM aikang.tbl_Order o",
        "WHERE o.colEmpID LIKE 'E%'",
        "  AND o.colOdrTim >= toStartOfMonth(toDate(#{date}) - INTERVAL 1 MONTH)",
